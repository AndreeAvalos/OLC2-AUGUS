...
class XMLHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        xmlElementFormat.setForeground(QColor("#33C7FF")) #cyan
        self.highlightingRules.append(("\$t[0-9]+", xmlElementFormat))
                #COLOR DE PARAMETROS
        xmlElementFormat = QTextCharFormat()
        xmlElementFormat.setForeground(QColor("#FB0B28")) #rojo
        self.highlightingRules.append(("\$a[0-9]+", xmlElementFormat))
                #COLOR DE RETORNOS
        xmlElementFormat = QTextCharFormat()
        xmlElementFormat.setForeground(QColor("#FFC133")) #naranja
        self.highlightingRules.append(("\$v[0-9]+", xmlElementFormat))
                #COLOR DE SIMULADOR
        xmlElementFormat = QTextCharFormat()
        xmlElementFormat.setForeground(QColor("#FF7D33")) #naranja fuerte
        self.highlightingRules.append(("\$ra", xmlElementFormat))
                #COLOR DE PILA
        xmlElementFormat = QTextCharFormat()
        xmlElementFormat.setForeground(QColor("#33FF86")) #veerde super claro
        self.highlightingRules.append(("\$s[0-9]+", xmlElementFormat))
                #COLOR DE PUNTERO PILA
        xmlElementFormat = QTextCharFormat()
